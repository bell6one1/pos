...
async function loadAllUiComponents() {
    const listKomponen = [
        ...
        { id: 'inject-tab-kasir', url: './components/tab-kasir.html' },
        { id: 'inject-tab-barang', url: './components/tab-barang.html' },
        { id: 'inject-tab-laporan', url: './components/tab-laporan.html' },
        { id: 'inject-tab-member', url: './components/tab-member.html' },
        { id: 'inject-tab-pengaturan', url: './components/tab-pengaturan.html' },
        { id: 'inject-modals', url: './components/modals.html' }
    ];

    for (const item of listKomponen) {
        try {
            ...
            console.error(`Kesalahan memuat ${item.url}:`, err);
        }
    }
}
